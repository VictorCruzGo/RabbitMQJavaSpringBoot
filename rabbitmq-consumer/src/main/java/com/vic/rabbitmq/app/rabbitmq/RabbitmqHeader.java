package com.vic.rabbitmq.app.rabbitmq;
...
public class RabbitmqHeader {
	...
	//header contiene los vaores de la cabecera del mensaje
	public RabbitmqHeader(Map<String, Object> headers) {
		if (headers != null) {
			...
			//Obtener los valores de x-death, variable donde se encuentran los valores para conocer la cantidad de reintentos al consumir el mensaje	
	...
	//Obtener la cantidad de reintentos de un mensaje. es decir que el mensaje haya pasado por el exchange y queue (WAIT)
