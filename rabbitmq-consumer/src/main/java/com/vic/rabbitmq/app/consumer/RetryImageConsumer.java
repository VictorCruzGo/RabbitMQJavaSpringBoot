...
public class RetryImageConsumer {
	...
	//Objecto para procesar el error.
	...
	public void listen(Message message, Channel channel)
		...
		try {
			...
			if (p.getSize() > 9000) {
				...
				System.out.println("CONSUMER IMAGE INFO--Creating thumbnail & publishing : " + p);
			...
			System.out.println("CONSUMER IMAGE WARM--Error processing message : " + new String(message.getBody()) + " : " + e.getMessage());
			//Verificamos la cantidad de reintentos
