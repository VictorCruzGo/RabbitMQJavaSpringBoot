...
import com.vic.rabbitmq.app.producer.AnotherDummyProducer;
...
public class RabbitmqProducerTwoApplication implements CommandLineRunner {
	...
	public void producerInvoiceAnotherDummy() throws InterruptedException {
			var message=new DummyMessage("Sending to exchange that does not exists yet", 1);
